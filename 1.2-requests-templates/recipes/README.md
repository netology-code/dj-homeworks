...
В этой работе необходимо реализовать обработку запросов и вывод рецептов через Django Templates.
...
- Проект запускается.
- Используется render().
- GET-параметр servings работает.
- Данные выводятся через шаблон.
