...
Не залезая в базу данных, без написания запросов.
...
1) С выводом в таблицу списком объектов.
...
Их можно загрузить коммандой: `python manage.py loaddata app.json`

Как изменять админку можно подсмотреть в документации
[подсмотреть в документации](https://docs.djangoproject.com/en/2.1/ref/contrib/admin/).
...
Там тот же python. Только мы не можем его менять.
